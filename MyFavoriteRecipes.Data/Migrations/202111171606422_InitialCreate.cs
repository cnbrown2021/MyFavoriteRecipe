namespace MyFavoriteRecipes.Data.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        CookingInstructions = c.String(nullable: false),
                        CategoryID = c.Int(nullable: false),
                        ReferenceID = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.RecipeID)
                .ForeignKey("dbo.MealCategory", t => t.CategoryID, cascadeDelete: true)
                ...
                c => new
                    {
                        ...
                        CookbookName = c.String(nullable: false),
                        CookbookAuthor = c.String(nullable: false),
                    })
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Recipes", "ReferenceID", "dbo.Reference");
            DropForeignKey("dbo.Recipes", "CategoryID", "dbo.MealCategory");
            DropIndex("dbo.IdentityUserLogin", new[] { "ApplicationUser_Id" });
            DropIndex("dbo.IdentityUserClaim", new[] { "ApplicationUser_Id" });
            DropIndex("dbo.IdentityUserRole", new[] { "ApplicationUser_Id" });
            DropIndex("dbo.IdentityUserRole", new[] { "IdentityRole_Id" });
            DropIndex("dbo.Recipes", new[] { "ReferenceID" });
